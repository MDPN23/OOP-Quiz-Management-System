 ...
 * @author Lenovo
 */
public class Dashboard_Quiz extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard_Quiz
     */
    public Dashboard_Quiz() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_Quiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboard_Quiz().setVisible(true);
            }
        });
    }
