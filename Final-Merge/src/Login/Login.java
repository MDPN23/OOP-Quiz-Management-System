...
import java.sql.*;
import javax.swing.*;
import pkgfinal.merge.*;
import pkgfinal.merge.Dashboard.Lecturer.Dashboard_Quiz_Lecturer;
import pkgfinal.merge.Dashboard.Student.Dashboard_Quiz_Student;
import pkgfinal.merge.Dashboard.Admin.Dashboard_Quiz_Admin;
...
public class Login extends javax.swing.JFrame {
    ...
    try {
        ...
        String query = "SELECT username, password FROM `data-mahasiswa` WHERE username=? AND password=?";
...
;            e.printStackTrace();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (loginController(jTextField1.getText(), jPasswordField1.getText())) {
                ...
                rs = ps.executeQuery();
                if (rs.next()) {
                    String nim = rs.getString(setValueof("nim"));
    ...
    private int setValueof(String nim) {
